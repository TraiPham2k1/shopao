...
<body class="js">
	...
	<!--/ End Slider Area -->
	<!-- Start Product Area -->
	<div id="MANDO" class="product-area section">
		<div class="container">
			<!-- Header -->
							...
							<div class="col-lg-8 col-md-12 col-12">
								...
								<div class="right-content">
									<ul class="list-main">
										...
										<li><span
											class="glyphicon glyphicon-log-in"></span><a href="dangkyController">Đăng ký</a></li>
										<%
										if (session.getAttribute("kh") == null) {
										%><li><i class="ti-user"></i> <a
											href="dangnhapController"> <spanclass="glyphiconglyphicon-log-in">
											...
											<div class="navbar-collapse">
												<div class="nav-inner">
													<ul class="nav main-menu menu navbar-nav">
														<li class="active"><a href="#MANDO">Home</a></li>
														...
														<li><a href="#">Blog<i class="ti-angle-down"></i></a>
															<ul class="dropdown">
																<li><a href="BlogController">Blog Single
																		Sidebar</a></li>
															</ul></li>
											...
											<div class="single-product">
												<div class="product-img">
													<a href="product-details.html"> <img
														class="default-img" src="<%=s.getAnh()%>" alt="#"> <!-- <img class="hover-img" src="//product.hstatic.net/1000401164/product/278486870_5148030511902986_6071858964300196736_n_f33a2e6b4bbb43319d69328f1788833b_master.jpg" alt="#"> -->
													</a>
													<div class="button-head">
														...
														<div class="product-action-2">
															<a title="Add to cart"
																href="giohangController?ms=<%=s.getMaao()%>&ts=<%=s.getTenao()%>&gia=<%=s.getGia()%>&anh=<%=s.getAnh()%>">Add
																to cart</a>
														</div>
													</div>
												</div>
												<div class="product-content">
													<h3>
														<a href="product-details.html"><%=s.getTenao()%></a>
													</h3>
