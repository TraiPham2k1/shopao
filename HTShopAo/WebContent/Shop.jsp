						...
						<div class="right-content">
							<ul class="list-main">
								...
								%><li><i class="ti-user"></i> <a href="dangnhapController">
										<spanclass ="glyphiconglyphicon-log-in">
										</span>My account
								</a></li>
								<%
								} else {
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="ShopController"><img src="./assets/images/mando.png"
								alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
						...
						<div class="search-bar-top">
							<div class="search-bar">
								<form action="HomeController">
									<input name="txttk" placeholder="Search Products Here....." type="search">
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-12">
					<div class="shop-sidebar">
						<!-- Single Widget -->
						<div id="Shop" class="single-widget category">
							...
							<!-- //hiển thị loại -->
								...
								%>
								<li><a href="ShopController?ml=<%=l.getMaloai()%>"> <%=l.getTenloai()%></li>
								<%
								}
								%>
							</ul>
							...
							<div class="single-product">
								<div class="product-img">
									<a href="product-details.html"> <img class="default-img"
										src="<%=s.getAnh()%>" alt="#"> <!-- <img class="hover-img" src="//product.hstatic.net/1000401164/product/278486870_5148030511902986_6071858964300196736_n_f33a2e6b4bbb43319d69328f1788833b_master.jpg" alt="#"> -->
									</a>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="./assets/images/mando.png"
									alt="logo"></a>
							</div>
