...
<!-- Title Tag  -->
	...
	<!-- Favicon -->
	<link rel="icon" type="./assets/image/png" href="https://theme.hstatic.net/1000401164/1000509982/14/favicon.png?v=592">
	<!-- Web Font -->
								...
								<div class="right-content">
									<ul class="list-main">
										...
										%><li><i class="ti-user"></i> <a href="dangnhapController">
												<spanclass="glyphiconglyphicon-log-in"> </span>My
												account 
										</a></li>
										<%
										} else {
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-2 col-md-2 col-12">
								<!-- Logo -->
								<div class="logo">
									<a href="HomeController"><img
										src="./assets/images/mando.png" alt="logo"></a>
								</div>
								<!--/ End Logo -->
								<!-- Search Form -->
				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<%
							...
							%>
							<tr>
								<td><input type="checkbox" name="check" value="<%=s.getMaao()%>"></td>
								<td class="image" data-title="No"><img src="<%=s.getAnh()%>" alt="#"></td>
								<td><%=s.getMaao()%></td>
								<td><%=s.getTenao()%></td>
								<td>$<%=s.getGia()%></td>
								<td><input name="<%=s.getMaao()%>" type="number" value="<%=s.getSoluong()%>" min="0">
								<button type="submit" name="butsua" value="<%=s.getMaao()%>"> Update</button></td>
								<td>$<%=s.getThanhtien()%></td>
								<td><button type="submit" name="butxoa" value="<%=s.getMaao()%>" class="btn btn-sm btn-danger"> <i class="ti-trash remove-icon"></i></button></td>
							<%
							}
							}
							%>
						...
						<button type="submit" name="butcheck" class="btn btn-default">CHOOSE DELETE</button>
					</form>
					
				<form action="dathangController" method="post">
					<button type="submit" name="abc" class="btn btn-default">COMFIRM</button>
				</form> 
				<%
			 	if (session.getAttribute("gio") != null) {
 				%>
				<h1>TOTAL MONEY:<%=gh.TongTien()%></h1> 
				<%
 				} else {
 					%>
				<h1>Tong=0 VNĐ</h1> 
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li>Cart Subtotal<span>$<%=gh.TongTien()%></span></li>
										<li>Shipping<span>Free</span></li>
										<li>You Save<span>$20.00</span></li>
										<li class="last">You Pay<span>$<%=gh.TongTien()-20000%></span></li>
									</ul>
									<div class="button5">
										<a href="CheckoutController" class="btn">Checkout</a>
										<a href="ShopController" class="btn">Continue shopping</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="HomeController"><img src="./assets/images/mando.png" alt="logo"></a>
							</div>
